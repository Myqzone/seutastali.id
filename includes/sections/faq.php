...
$faq_show_footer_text = isset($faq_show_footer_text) ? $faq_show_footer_text : true;
$faq_button_text = isset($faq_button_text) ? $faq_button_text : 'Email Kami';
$faq_button_link = isset($faq_button_link) ? $faq_button_link : 'mailto:hello@seutastali.id';
?>
...
<section class="py-5" id="faq">
    <div class="container">
        <div class="d-flex flex-column gap-4 gap-md-4">
            ...
            <div class="section-header text-center px-4 pb-4 px-md-0 pb-md-0" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
            ...
            <!-- 2. Section Content -->
            <div class="section-content mx-auto w-100" style="max-width: 850px;">
                <div class="accordion accordion-flush brand-faq-accordion mb-0" id="<?= $faq_accordion_id ?>">
                    <?php
                    try {
                        if ($conn && !$conn->connect_error) {
                            $result = $conn->query("SELECT * FROM dev_faqs ORDER BY sort_order ASC, id ASC LIMIT $faq_limit");
            ...
            <!-- 3. Section Footer -->
             <div class="section-footer text-center d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
                <?php if ($faq_show_footer_text): ?>
                <p class="mb-3 text-muted small">Punya pertanyaan lain?</p>
                <?php endif; ?>
                <a href="<?= htmlspecialchars($faq_button_link) ?>" class="btn btn-primary">
                    <?= htmlspecialchars($faq_button_text) ?>
                </a>
            </div>
        </div>
    </div>
